      ...
      <div className="mx-auto px-4 flex items-center justify-between">
        <div className="flex font-bold items-center">
          <img
            src="/icon.svg"
            alt="Logo"
            className="h-[60px] w-[60px] bg-[#fff7e4] p-2 border-4"
          />
          
          <h1 className="text-[#1f1a14] text-xl sm:text-xl md:text-[32px] ml-2 font-bold">{GreetingTxt}</h1>
        </div>
        ...
        <div className="md:hidden"> 
          <button
            ...
            className="px-3 py-2 bg-[#1f1a14] text-[#fff7e4] border-[#1f1a14] border-2" 
